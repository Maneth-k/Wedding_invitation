...
export default function PoruwaCeremony() {
  return (
    <div className="pt-4 sm:pt-6 md:pt-8 pb-6 w-full">
      ...
      {/* Ceremony Card */}
      <div className="group relative bg-[#ffffff]/75 backdrop-blur-xs border border-[#ecdccf] rounded-2xl p-4 sm:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300 hover:shadow-[0_12px_36px_rgba(75,50,35,0.08)] flex flex-col items-center text-center">
        {/* Decorative Icon */}
        ...
        {/* Ceremony Title */}
        <h3 className="font-playfair text-lg sm:text-2xl md:text-3xl font-semibold tracking-wider text-[#a0715b]">
          Poruwa Ceremony
        </h3>
